...
List<String> _multiAdaptationCommandFlowLines() {
  return [
    ...
    '4. OHOS loop: run `fluoh run --platform ohos --package <name> --json --trace-dir <trace-dir>`, or add `--device <id>` for a connected hdc target. This proves build, signing, install, launch, and hilog diagnostics; then complete required example functional interactions with AI-assisted automation when possible and record evidence. If no target is available, run `fluoh build --platform ohos --package <name> --auto-sign --json --trace-dir <trace-dir>` as build-only evidence and record the blocker.',
...
List<String> _singleAdaptationCommandFlowLines(
  ...
  return [
    ...
    '4. OHOS loop: run `${package.ohosRunCommand} --trace-dir <trace-dir>`, or `${package.ohosDeviceRunCommand} --trace-dir <trace-dir>` for a connected hdc target. This proves build, signing, install, launch, and hilog diagnostics; then complete required example functional interactions with AI-assisted automation when possible and record evidence. If no target is available, run `${package.ohosBuildCommand} --trace-dir <trace-dir>` as build-only evidence and record the blocker.',
