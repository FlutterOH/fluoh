...
Future<Directory> _createDepsGetSdkSource(
  Directory parent,
  Directory project,
) async {
  final source = Directory('${parent.path}/deps_get_source');
  final sdkRepository = Directory('${parent.path}/deps_get_sdk');
...
#!/bin/sh
printf "%s::%s\\n" "\$(pwd)" "\$*" >> "${project.path}/deps_get_invocations.txt"
